...
namespace EquipoFutbol1.Controllers
{
    public class EquiposController : Controller
    {
        ...
        public EquiposController(FutbolContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var equipo = await _context.Equipos.SingleOrDefaultAsync(m => m.IdEquipo == id);
            if (equipo == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEquipo,NombreEquipo")] Equipo equipo)
        {
